  ...
  return (
    <div className="languages">
      <div className="logo-home">
        {location.pathname !== "/" && (
          <Link className="leng-home" to="/">
            <img src={house} alt="home" />
          </Link>
        )}
      </div>
      <div className="spain" onClick={() => changeLanguaje("es")}>
        <img type="spain" src={spanish} alt="spain" />
      </div>
      ...
      <div className="leng" onClick={() => changeLanguaje("en")}>
        <img type="english" src={english} alt="english" />
      </div>
